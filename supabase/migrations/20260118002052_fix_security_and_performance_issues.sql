/*
  ...
  1. Optimize RLS policies - use (select auth.uid()) for better performance
  2. Remove unused indexes to save space
  3. Fix function search paths
*/

-- Fix RLS policy for better performance
...
-- Drop unused indexes (they're not being used by queries)
DROP INDEX IF EXISTS "SEMAPHOR_intersectionId_idx";
DROP INDEX IF EXISTS "BUS_STATION_intersectionId_idx";
DROP INDEX IF EXISTS "TRAM_STATION_intersectionId_idx";
DROP INDEX IF EXISTS "TROLEIBUS_STATION_intersectionId_idx";
DROP INDEX IF EXISTS "CROSSING_CAR_semaphorId_idx";
DROP INDEX IF EXISTS "CROSSING_BUS_semaphorId_idx";
DROP INDEX IF EXISTS "CROSSING_BUS_busId_idx";
DROP INDEX IF EXISTS "CROSSING_TRAM_semaphorId_idx";
DROP INDEX IF EXISTS "CROSSING_TRAM_tramId_idx";
DROP INDEX IF EXISTS "CROSSING_TROLEIBUS_semaphorId_idx";
DROP INDEX IF EXISTS "CROSSING_TROLEIBUS_troleibusId_idx";
DROP INDEX IF EXISTS "CROSSING_PERSON_semaphorId_idx";
DROP INDEX IF EXISTS "CROSSING_PERSON_personId_idx";
DROP INDEX IF EXISTS "STOPPED_BUS_busId_idx";
DROP INDEX IF EXISTS "STOPPED_BUS_stationId_idx";
DROP INDEX IF EXISTS "STOPPED_TRAM_tramId_idx";
DROP INDEX IF EXISTS "STOPPED_TRAM_stationId_idx";
DROP INDEX IF EXISTS "STOPPED_TROLEIBUS_troleibusId_idx";
DROP INDEX IF EXISTS "STOPPED_TROLEIBUS_stationId_idx";
DROP INDEX IF EXISTS "CHANGING_semaphorId_idx";
...
DROP FUNCTION IF EXISTS get_recent_violations(INTEGER, INTEGER);
